...
public class DefaultCombinator3<T1, T2, T3> extends DefaultCombinator2<T1, T2>
  ...
  @Override
  public <R> Arbitrary<R> as(Combinators.F3<T1, T2, T3, R> combinator) {
  ...
  protected <R> Function<List<Object>, R> combineFunction(
      Combinators.F3<T1, T2, T3, R> combinator) {
  ...
  private static class Filtered<T1, T2, T3> extends DefaultCombinator3<T1, T2, T3> {
    ...
    private Filtered(
        ...
        Arbitrary<T2> a2,
        Arbitrary<T3> a3,
        Combinators.F3<T1, T2, T3, Boolean> filter) {
      super(a1, a2, a3);
      this.filter = filter;
    }
    ...
    private Combinators.F3<T1, T2, T3, Boolean> combineFilters(
        Combinators.F3<T1, T2, T3, Boolean> filter1, Combinators.F3<T1, T2, T3, Boolean> filter2) {
