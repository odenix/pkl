...
public class DefaultArrayArbitrary<T, A> extends MultivalueArbitraryBase<T, A>
    implements ArrayArbitrary<T, A> {

  public static <T, A> ArrayArbitrary<T, A> forArrayType(
      Arbitrary<T> elementArbitrary, Class<A> arrayClass) {
  ...
  public static <T> ArrayArbitrary<T, T[]> forComponentType(
      Arbitrary<T> elementArbitrary, Class<?> componentType) {
