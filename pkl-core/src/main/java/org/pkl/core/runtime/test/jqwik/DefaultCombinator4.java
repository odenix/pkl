...
public class DefaultCombinator4<T1, T2, T3, T4> extends DefaultCombinator3<T1, T2, T3>
    implements Combinators.Combinator4<T1, T2, T3, T4> {

  protected final Arbitrary<T4> a4;

  public DefaultCombinator4(
  ...
  @Override
  public Combinators.Combinator4<T1, T2, T3, T4> filter(
  ...
  protected <R> Function<List<Object>, R> combineFunction(
      Combinators.F4<T1, T2, T3, T4, R> combinator) {
    return params ->
        combinator.apply(
            (T1) params.get(0), (T2) params.get(1), (T3) params.get(2), (T4) params.get(3));
  }
