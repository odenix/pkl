...
public class SourceOfRandomness {
  ...
  private static final ThreadLocal<Random> current =
      ThreadLocal.withInitial(SourceOfRandomness::newRandom);
  ...
  /**
   * A faster but not thread safe implementation of {@linkplain java.util.Random}. It also has a
   * period of 2^n - 1 and better statistical randomness.
   *
   * <p>See for details: https://www.javamex.com/tutorials/random_numbers/xorshift.shtml
   *
   * <p>For further performance improvements within jqwik, consider to override:
   *
   * <ul>
   *   <li>nextDouble()
   *   <li>nextBytes(int)
